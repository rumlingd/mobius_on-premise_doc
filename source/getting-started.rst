...
::
  ...
  nvidia-docker run -v sim_search_data:/data -v sim_search_redis:/var/lib/redis -p 5000:5000 -e CUDA_VISIBLE_DEVICES="0" -e NUM_WORKERS="40" -e MOBIUS_TOKEN="<your_token>" -it mobius_labs/mobius_sdk_sim_search:0.1
